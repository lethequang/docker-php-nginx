# PHP 8 development environment with PHP-FPM, Nginx, using Docker and Docker Compose
...
- Now go to your browser and access your server’s domain name or IP address on port `80`: `http://server_domain_or_IP:80`. In case you are running this demo on your local machine, use `http://localhost:80` to access the application from your browser.
